...
import com.example.krzaczek.smartbuilding.utils.AllViewAdapter;
import com.example.krzaczek.smartbuilding.utils.CustomComparator;
...
public class AllViewActivity extends Activity {
    ...
    private static final String URL = SmartBuildingConstants.IP + "/all";
    TextView textView;
